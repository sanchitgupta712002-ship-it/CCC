(function () {
  ...
  async function checkAiStatus() {
    try {
      ...
      state.ai.lastError = data.configured ? "" : "Set OPENAI_API_KEY to enable live AI.";
    } catch (error) {
      state.ai.checked = true;
      ...
      state.ai.model = null;
      state.ai.lastError = "Run globalsync_server.py with OPENAI_API_KEY to enable live AI.";
    }
    render();
  }
  ...
  async function getAiPersonaReply(scenario, learnerText) {
    try {
      ...
      state.ai.provider = "OpenAI Responses API";
  ...
  function renderTopbar() {
    ...
    return `
      <header class="topbar">
        <div class="brand">
          <img src="assets/thunderbird-logo.png" alt="Thunderbird Global Executive Education" />
